...
class ConvertToWords {
	...
	public static void converToWords(char[] num) {
	...
	public static void main(String[] args) {
		converToWords("9923".toCharArray());
		converToWords("523".toCharArray());
		converToWords("89".toCharArray());
		converToWords("8989".toCharArray());
	}
}
